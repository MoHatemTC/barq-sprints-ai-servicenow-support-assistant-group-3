...
from retriever import retrieve_relevant_chunks, DEFAULT_QDRANT_URL, DEFAULT_QDRANT_API_KEY
...
# Test 1: Successful retrieval (Score >= Threshold)
...
# Test 2: Threshold Gate Refusal (Score < Threshold)
...
# Test 3: Optional Category Filter Test
...
result_category = retrieve_relevant_chunks(
    ...
    collection_name="kb_articles",
    top_k=2,
    category="NonExistingCategory123",  # Category that doesn't exist
    threshold=0.50,
    client=client
)
